...
#define LOWEST_ENERGY_MODE	3									// Defines which Energy Mode is the Board working in
	...
	//DOS ???? #define SLEEP_SleepBlockBegin(sleepEM1)						// Block Energy modes equal to and greater than EM1
#endif
	...
	//DOS ???? #define SLEEP_SleepBlockBegin(sleepEM2)						// Block Energy modes equal to and greater than EM2
#endif
	...
	//DOS ???? #define SLEEP_SleepBlockBegin(sleepEM3)						// Block Energy modes equal to and greater than EM3
#endif
	...
	//DOS ???? #define SLEEP_SleepBlockBegin(sleepEM4)						// Block Energy modes equal to and greater than EM4
#endif
